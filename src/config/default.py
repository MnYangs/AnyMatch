...
# VisTir options
_CN.DATASET.VISTIR_IMG_RESIZE = 640  # resize the longer side, zero-pad bottom-right to square.   640
...
##############  Test/Inference  ##############
_CN.TEST = CN()
_CN.TEST.IMG0_RESIZE = 640 # resize the longer side  640
_CN.TEST.IMG1_RESIZE = 640 # resize the longer side  EDM:832
_CN.TEST.DF = 8
_CN.TEST.PADDING = True  # pad img to square with size = IMG0_RESIZE, IMG1_RESIZE  EDM AND LOFTR:True   ROMA:False

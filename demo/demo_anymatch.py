...
if __name__ == '__main__':
    def add_common_arguments(parser):
        ...
        parser.add_argument('--fig1', type=str, default="vis_test.png")
        parser.add_argument('--fig2', type=str, default="depth_test.png")
    ...
    def add_method_arguments(parser, method):
        ...
        if method == "loftr":
            parser.add_argument('--ckpt', type=str,
                                default="../weights/LoFTR_AnyMatch.ckpt")
            parser.add_argument('--thr', type=float, default=0.1)
        elif method == "edm":
            parser.add_argument('--ckpt', type=str,
                                default="../weights/EDM_AnyMatch.ckpt")
        elif method == "roma":
            parser.add_argument('--ckpt2', type=str,
                                default="large")
            parser.add_argument('--ckpt', type=str,
                                default='../weights/RoMa_AnyMatch.pth')
        else:
    ...
    parser.add_argument('--method', type=str, required=False, default="loftr",
                        choices=['loftr', 'roma', 'edm'],
                        help="Select the method to use: 'loftr', 'roma', 'edm'")

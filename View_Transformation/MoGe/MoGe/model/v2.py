    ...
    def infer(
        ...
        with torch.autocast(device_type=self.device.type, dtype=torch.float32):
            ...
            if points is not None:
                ...
                intrinsics = utils3d.torch.intrinsics_from_focal_center(fx, fy, torch.tensor(0.5, device=fx.device, dtype=fx.dtype), torch.tensor(0.5, device=fx.device, dtype=fx.dtype))
